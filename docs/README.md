...
Full attribute-by-attribute details are in [`Fieldwalking project explained`](docs/fieldwalking_project/documentation/field_walking_geopackage/Fieldwalking%20project%20explained.md).
