...
- [**`areas_covered`**](./fieldwalking_project/documentation/Fieldwalking%20project%20explained.md#areas_covered) (polygon) — the ground actually walked, with an auto-recorded date, for spatial coverage analysis.
